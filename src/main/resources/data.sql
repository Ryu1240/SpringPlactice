...
INSERT INTO meeting_room (room_name) VALUES ('銀座１丁目');
...
-- 認証確認用のテストユーザー
INSERT INTO usr (user_id, first_name, last_name, password, role_name)
VALUES('aaaa','Aaa','Aaa','$2a$10@oxSJl.keBwxmsMLKcT9lPeAIxfNTPNQxpeywMrF7A3kVszwUTqfTK','USER');
INSERT INTO usr (user_id, first_name, last_name, password, role_name)
